...
我之前使用 [Vercel](https://vercel.com) 一把梭，无需任何配置，我只需要专注输出内容即可，这是我当时使用 Vercel 部署的文章 [Vercel 部署个人博客]
...
![image-20221204161431863](https://img.mongorolls.cn/image-20221204161431863.png)
...
以下是我的网站测速结果，也可通过访问 [mongorolls.cn 在全国各地区网络速度测试情况-Ping.cn](https://www.ping.cn/http/mongorolls.cn) 在线查看

![image-20221204161146327](https://img.mongorolls.cn/image-20221204161146327.png)
...
这里我是借助了 [Github Action](https://github.com/marketplace) 来帮助我构建，构建记录可以在 [Actions · kuizuo/blog](https://github.com/mongoRolls/blog/actions) 中查看。以下是我的配置文件
