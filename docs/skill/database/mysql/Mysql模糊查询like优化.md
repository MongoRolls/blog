...
![image-20210116000628122](https://img.mongorolls.cn/image-20210116000628122.png)
...
上面写到 %keyword% 用不到索引，但如果给字段添加一个前缀文本，比如我这里添加为 KZTK\_(MongoRolls题库)，然后拼接为 KZTK\_%keyword%
