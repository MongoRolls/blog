...
在 [模拟请求|协议复现方案](https://mongorolls.cn/request-protocol-scheme '模拟请求|协议复现方案') 这篇文章中我对协议复现的一些方案总结，而这篇就是对 SSR 框架方案的一个具体实践。
...
这里我不想过多介绍 Nuxt3 的基本功能与使用，在我的一个 [基于 Nuxt3 的 API 接口服务网站](https://mongorolls.cn/use-nuxt3-build-api-server#nuxt3-介绍 '基于Nuxt3的API接口服务网站') 的项目中，有简单介绍过 Nuxt3，有兴趣可以去看看。
...
![](https://img.mongorolls.cn/image_75GsdEZuLK.png)
...
export class Blog {
  ...
  constructor(user: User) {
    this.http = new AHttp({ baseURL: 'https://blog.mongorolls.cn' })
    this.user = User
  }
