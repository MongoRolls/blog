...
![](https://img.mongorolls.cn/image_StiMqQrFCi.png)
...
![](https://img.mongorolls.cn/image_Yv4X32qLE5.png)
...
export function activate(context: vscode.ExtensionContext) {
  vscode.window
    ...
    .then(result => {
      if (result === '是') {
        exec(`start 'https://mongorolls.cn'`)
      } else if (result === '不再提示') {
        // 其他操作 后文会说
      }
    })
...
![](https://img.mongorolls.cn/image_9oqLzZl-wE.png)
...
const commandLine =
  os.platform() === 'win32' ? `start https://mongorolls.cn` : `open https://mongorolls.cn`
exec(commandLine)
```
...
![](https://img.mongorolls.cn/image_teNrxe9D9O.png)
...
![](https://img.mongorolls.cn/image_3SRybBGaF1.png)
...
![](https://img.mongorolls.cn/image_nQu3Y8DWSw.png)
...
![](https://img.mongorolls.cn/image_SnnPUABJN5.png)
...
![](https://img.mongorolls.cn/image_yQRsMkT6f5.png)
...
![](https://img.mongorolls.cn/image_-ZCy88xVyq.png)
...
![](https://img.mongorolls.cn/image_RUIjdDI90l.png)
...
![](https://img.mongorolls.cn/image_nVO_YmRit4.png)
...
![](https://img.mongorolls.cn/token1_JNXknLPQyJ.png)

**2、新建一个 token**

![image-20220831152146541](https://img.mongorolls.cn/image-20220831152146541.png)
...
![](https://img.mongorolls.cn/image_HssaMdar8f.png)
...
![vscode-extension](https://img.mongorolls.cn/image-20220711195038039.png)
