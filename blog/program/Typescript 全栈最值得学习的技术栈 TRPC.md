...
image: https://img.mongorolls.cn/trpc-banner.png
...
在线体验地址：[TRPC demo](https://trpc.mongorolls.cn/)
...
![image-20230308142331808](https://img.mongorolls.cn/image-20230308142331808.png)
...
![image-20230308142452678](https://img.mongorolls.cn/image-20230308142452678.png)
...
![](https://img.mongorolls.cn/image_YDKc7TixQA.png)
...
![](https://img.mongorolls.cn/image_WfW8ehqUKz.png)

![](https://img.mongorolls.cn/image_qicvoGjshx.png)
...
![](https://img.mongorolls.cn/20230307214659.png)
...
![](https://img.mongorolls.cn/image_ufrhaugaIj.png)

![](https://img.mongorolls.cn/image_cvlDJjhwPl.png)

分别输出三者 result 也没有任何问题。

![](https://img.mongorolls.cn/image_hbL8So_RzB.png)
...
![](https://img.mongorolls.cn/image_-qEI8jR1uM.png)

![](https://img.mongorolls.cn/image_RTdWJn_55p.png)
...
![](https://img.mongorolls.cn/image_8BUcBPK8In.png)
...
![](https://img.mongorolls.cn/image_ERGzEt2Tq8.png)
...
![](https://img.mongorolls.cn/image_QBXnHdoewh.png)
...
![](https://img.mongorolls.cn/image__B1RYeiFze.png)
  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials, req) {
        ...
        const user = { id: '1', name: 'kuizuo', email: 'hi@mongorolls.cn' }
...
![](https://img.mongorolls.cn/image_9eowvvnwU2.png)
...
![](https://img.mongorolls.cn/image_7_XKmbuK87.png)
...
这里我提供了一个简单的示例，你可以 [点我](https://trpc.mongorolls.cn) 访问体验一下（项目部署在 Vercel，而数据库服务在腾讯云，登录服务又依赖 Github，所以项目会稍微有那么慢）。整个项目结构大致如下

![](https://img.mongorolls.cn/image_z_YaR-RnSu.png)
